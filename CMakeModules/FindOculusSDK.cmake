...
FIND_LIBRARY(OCULUS_SDK_KERNEL_LIBRARY NAMES libovrkernel HINTS ${OCULUS_SDK_ROOT_DIR}
													${OCULUS_SDK_ROOT_DIR}/LibOVRKernel/Lib/Windows/Win32/Release/${_OCULUS_MSVC_DIR})
...
MARK_AS_ADVANCED(OCULUS_SDK_KERNEL_LIBRARY)

Message(STATUS "${OCULUS_SDK_LIBRARIES}")
...
SET(OCULUS_SDK_KERNEL_LIBRARIES ${OCULUS_SDK_KERNEL_LIBRARY})
...
FIND_PACKAGE_HANDLE_STANDARD_ARGS(OculusSDK DEFAULT_MSG OCULUS_SDK_LIBRARIES OCULUS_SDK_INCLUDE_DIRS OCULUS_SDK_KERNEL_LIBRARIES)

MARK_AS_ADVANCED(OCULUS_SDK_LIBRARIES OCULUS_SDK_INCLUDE_DIRS OCULUS_SDK_KERNEL_LIBRARIES)
